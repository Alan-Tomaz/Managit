...
function ItemsCard({ option = 0 }) {
    ...
    const initialFilterObj = {
        ...
        permission: 0,
        status: 0,
        category: [{ name: 't-shirt', isShow: true }, { name: 'shoes', isShow: true }, { name: 'jenas', isShow: true }],
        ...
        option4: 'min-content 100px 150px 100px 100px 100px 1fr 100px 100px',
 ...
 */    }
    ...
    const handleFilter = () => {
        ...
        setRenderFilter({ ...filter, [`option${option}`]: newColumns, filteringColumns: filteringColumn })
    ...
    const handleUncheckSupplier = (index) => {
        const updatedFilter = { ...filter };
        updatedFilter.supplier[index].isShow = !updatedFilter.supplier[index].isShow;
        setFilter(updatedFilter);
    }
                    ...
                    <div className="stock__info">
                        <div className="stock__tags">
                            ...
                            {renderFilter.filteringColumns.length != 0 &&
                                <div className="stock__tag">
                                    <span>Not Show: {`${renderFilter.filteringColumns.map((elem) => elem.charAt(0).toUpperCase() + elem.slice(1).replace('-', ' ') + '')}`}</span>
                                    <div className="stock__vl"></div>
                                    <HiOutlineXMark className='stock__tag-mark' onClick={handleRemoveTag('order')} />
                                </div>
                            }
